...
class ReceiptService
{
    ...
    public function validateFile(?array $file)
    {
        if (!$file || $file['error'] !== UPLOAD_ERR_OK) {
            throw new ValidationException([
                'receipt' => ['Failed to uploaded file']
            ]);
        }
    ...
    public function upload(array $file, int $transaction)
    {
        ...
        $sql = "INSERT INTO receipts (transaction_id, original_filename, storage_filename, media_type) 
    ...
    {
        $filePath = Paths::STORAGE_UPLOADS . DIRECTORY_SEPARATOR . $receipt['storage_filename'];
